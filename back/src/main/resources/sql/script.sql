...
ALTER TABLE `ARTICLES` ADD FOREIGN KEY (`user_username`) REFERENCES `USERS` (`username`) ON UPDATE CASCADE;
ALTER TABLE `ARTICLES` ADD FOREIGN KEY (`theme_id`) REFERENCES `THEMES` (`id`);

ALTER TABLE `COMMENTS` ADD FOREIGN KEY (`user_username`) REFERENCES `USERS` (`username`) ON UPDATE CASCADE;
...
VALUES (
  'testAngular',
  'testAnuglar@gmail.com',
  '$2a$10$ycAKdhz0RL0TW7u0uWRWMO5yR/vca9v28fpCZFKArRKi8f4wvFrWm'
);
